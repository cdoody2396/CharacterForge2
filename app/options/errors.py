"""Error taxonomy for the option format (spec §10).
...
# --- age-band codes (§8) ---------------------------------------------------
BAND_FILE_MISSING = "BAND_FILE_MISSING"
BAND_BAD_BOUND = "BAND_BAD_BOUND"
BAND_WRONG_FLOOR = "BAND_WRONG_FLOOR"
BAND_GAP = "BAND_GAP"
BAND_OVERLAP = "BAND_OVERLAP"
BAND_OPEN_NOT_LAST = "BAND_OPEN_NOT_LAST"
BAND_NO_OPEN_BAND = "BAND_NO_OPEN_BAND"
BAND_MISSING_IMAGE_TEXT = "BAND_MISSING_IMAGE_TEXT"
...
class AgeBandFormatError(ValueError):
    """The age-band lookup file violates §8."""

    def __init__(self, file: str, code: str, message: str):
        self.file = file
        self.code = code
        super().__init__(f"{file}: [{code}] {message}")
