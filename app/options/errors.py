...
# O3_INPUTS N3: `required` is legal on pick kinds only — meaningless on
# free_text and on session homes; each illegality has its own code.
REQUIRED_ON_FREE_TEXT = "REQUIRED_ON_FREE_TEXT"
REQUIRED_ON_SESSION_HOME = "REQUIRED_ON_SESSION_HOME"
